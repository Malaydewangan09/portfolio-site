  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Malay Dewangan | Software Developer</title>
      ...
      <div className="after-animation">
          ...
          <nav className="home-nav">
            <div className="space-between">
              ...
              <ul className="nav-list">
                ...
                <li>
                  <motion.a
                    href="https://github.com/Malaydewangan09"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <motion.a
                    href="https://www.linkedin.com/in/malay-dewangan-156b58186/"
                    target="_blank"
                    rel="noopener noreferrer"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
        ...
        <main className="main-home">
          <div className="cta">
            <h1 className="title">
              I create and manage<span className="playful"> playful </span> experiences and architecture.
            </h1>
            <img
          ...
          <p className="job-title">
            <span className="text-reveal">
             Malay Dewangan / Software Developer
            </span>
          </p>
